                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select id="receiver_id" name="receiver_id" class="selectpicker form-control"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="expense_category_id" id="expense_category_modal_id"
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="warehouse_id" id="expense_modal_warehouse_id"
                                    class="selectpicker form-control" required data-live-search="true"
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>{{ trans('file.Warehouse') }} *</label>
                            <select name="warehouse_id" id="warehouse_modal_id" class="selectpicker form-control"
                                required data-live-search="true" id="warehouse-id" data-live-search-style="begins"
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>{{ trans('file.User') }} *</label>
                            <select name="user_id" id="user_modal_id" class="selectpicker form-control" required
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="customer_id" id="customer_modal_id" class="selectpicker form-control"
                                required data-live-search="true" data-live-search-style="begins"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="customer_group_id" id="customer_group_modal_id"
                                class="selectpicker form-control" required data-live-search="true"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="supplier_id" id="supplier_modal_id" class="selectpicker form-control"
                                required data-live-search="true" id="supplier-id" data-live-search-style="begins"
