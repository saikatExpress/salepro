                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group option-value d-none">
                                    <label>{{ trans('file.Options') }} *</label> <i class="dripicons-question"
                                        data-toggle="tooltip"
                                        title="{{ trans('file.Only use for Select, Multi Select, Checkbox, Radio Button types. Populate the field by separating the options by coma. eq. apple,orange,banana') }}"></i>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control mt-0" type="number" name="grid_value" required
