    ...
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            ...
            <div class="content">
                ...
                <h4>Great! System Test Completed. You can run SalePro on your server. Click Continue For Next Step.</h4>
                <a href="step3.php" class="btn btn-primary">Continue</a>

                <?php else: ?>

                <br /><?php echo $ltext; ?><br />Sorry. The requirements of SalePro is not available on your server.
                Please contact with us- hello@lion-coders.com with this code- <?php echo $passed; ?> Or contact with
                your server administrator.<br><br>
